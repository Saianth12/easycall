...
<div class="container">
    ...
    <div class="row">
      ...
      <tbody>
          <?php
            $sqlnumb = "SELECT * FROM location_details";
        ...
        <tr>
          ...
          <td><a href="delete_function.php?Id=<?php echo $row['Id'];?>&delete_location=search"><i class="fa fa-trash fa-fw" aria-hidden="true"></i></a>
          <a href="edit_location.php?Id=<?php echo $row['Id'];?>"><i class="fa fa-edit fa-fw" aria-hidden="true"></i></a>
          <a href="team_leader_location_map.php?Id=<?php echo $row['Id'];?>"><i class="fa fa-map-marker fa-fw" aria-hidden="true"></i></a>
          </td>
        </tr>
        <?php
	        }
