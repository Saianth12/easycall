...
<div class="row mb40">
				...
				if (isset($_POST['submit'])){
				    ...
				    //SELECT * FROM wholeday_tracking WHERE employee_id='82' and cur_date between '04-06-2019 09:00:00' and '04-06-2019 21:00:00' 
				    
				    $sql3 = "SELECT * FROM current_location WHERE employee_id='".$_POST['teaml']."' and date between '".$datefils."' and '".$datefilss."'";
                    $result3 = mysqli_query($conn,$sql3);
                    while($final_data3 = mysqli_fetch_array($result3)){
                    $executive_location_lat = $final_data3['current_lat'];
                    $executive_location_long = $final_data3['current_lang'];
                    
                    $date = explode(' ',$final_data3['date']);
                    $dates[1] = '12:02:23';
                    $dates[2] = '12:02:34';
				...
				<ol>
				    ...
				    $sql4 = "SELECT * FROM current_location WHERE employee_id='".$_POST['teaml']."' and date like '%".$datefil."%' group by client_id";
                    $result4 = mysqli_query($conn,$sql4);
				    
				    while($final_data4 = mysqli_fetch_array($result4)){ 
				    $rrt = explode(' ',$final_data4['date']);
				    ?>
				    <li><a href="http://maps.google.com/maps?z=12&t=m&q=loc:<?php echo $final_data4['current_lat']; ?>+<?php echo $final_data4['current_lang']; ?>" target="_blank"><?php echo "Lat: ".$final_data4['current_lat']."            Lang: ".$final_data4['current_lang'];?></a>    :Time        <?php echo $rrt[1]; ?></li>
