...
<div class="row mb40">
				...
				<form method="post" action="includes/submit.php">
					<input type="text" name="c_name" placeholder="Name" required="" pattern="[A-Za-z\\s]*">
					<input type="email" name="email" placeholder="Email" required="">
					<input type="text" name="phone" class="lock" placeholder="Phone" required="" pattern="^\d{10}$">
					<?php
					if($employee_type == 1){
					?>
					...
					<input type="hidden" name="teamleader" value="<?php echo $employee_id; ?>" placeholder="Password" required="">
					<?php
					}
					?>
					<span id="teaml"></span>
