...
<div class="container">
    ...
    <div class="row">
      ...
      <tbody>
          <?php
            $sqlnumb = "SELECT * FROM attendance_details";
        ...
        <tr>
          ...
          <td>
          <a href="delete_function.php?Id=<?php echo $row['Id'];?>&atten_status=search">A</a> |
          <a href="delete_function.php?Id=<?php echo $row['Id'];?>&atten_status=search1">P</a>
          </td>
        </tr>
        <?php
	        }
