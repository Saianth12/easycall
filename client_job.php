...
<div class="container">
    ...
    <div class="row">
      ...
      <tbody>
          <?php
            //$sqlnumb = "SELECT *,client_location.Id as KI,team_leader.Id as IO FROM client_location,team_leader WHERE client_location.employee_id=team_leader.employee_id";
            $sqlnumb = "SELECT * FROM current_location";
	        $aqs = mysqli_query($conn,$sqlnumb);
	        while($row= mysqli_fetch_array($aqs)){
	            $sqlnumb1 = "SELECT * FROM profile_details WHERE Id='".$row['employee_id']."'";
        ...
        <tr>
          ...
          <td><?php echo $row['current_lang']; ?></td>
          <td><?php echo $row['current_address']; ?></td>
          <td><?php echo $row['client_id']; ?></td>
          <td><?php echo $row['date']; ?></td>
          <td><a href="delete_function.php?Id=<?php echo $row['Id'].",".$row['IO'];?>&client_job_deletion=search"><i class="fa fa-trash fa-fw" aria-hidden="true"></i></a>
          <?php /* ?><a href="edit_location.php?Id=<?php echo $row['Id'];?>"><i class="fa fa-edit fa-fw" aria-hidden="true"></i></a> <?php */ ?>
          <a href="maplocation.php?Id=<?php echo $row['Id'];?>"><i class="fa fa-map-marker fa-fw" aria-hidden="true"></i></a>
          </td>
        </tr>
        <?php
	        }
